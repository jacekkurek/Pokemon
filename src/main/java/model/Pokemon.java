...
public abstract class Pokemon {
    ...
    public void heal(int hp) throws BadPotionExeption, DeadPokemonExeption {
        if (hp < 0) {
            throw new BadPotionExeption("Heal value can only be positive");
        }
        if (currentHP > 0) {
            ...
            throw new DeadPokemonExeption("Your Pokemon is dead...");
        }
    ...
    private final void attackInfo(int dmg) {
